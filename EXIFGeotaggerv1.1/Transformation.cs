...
namespace ShapeFile
{
    ...
    public static unsafe class Transformation
    {
        ...
        /*                                                                         */
        /***************************************************************************/
        private static double meridian_arc(tmprojection* tm, double lt)
        {
            double e2 = tm->e2;
            double a = tm->a;
            double e4;
        ...
        private static void define_tmprojection(tmprojection* tm, double a, double rf, double cm, double sf, double lto, double fe, double fn, double utom)
        {
            double f;
            tm->meridian = cm;
            tm->scalef = sf;
        ...
        private static tmprojection* get_nztm_projection()
        {
        ...
        */
        ...
        public static void geod_nztm(double lt, double ln, double* n, double* e)
        {
            tmprojection* nztm = get_nztm_projection();
